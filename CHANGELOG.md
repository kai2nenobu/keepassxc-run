...
## [v0.1.1](https://github.com/kai2nenobu/keepassxc-run/compare/v0.1.0...v0.1.1) - 2025-05-04
- Restore KeePassXC database for test and test with it by @kai2nenobu in https://github.com/kai2nenobu/keepassxc-run/pull/14
- build(deps): bump astral-sh/setup-uv from 4 to 5 in the all group by @dependabot in https://github.com/kai2nenobu/keepassxc-run/pull/20
...
- build(deps): bump astral-sh/setup-uv from 5 to 6 in the all group by @dependabot in https://github.com/kai2nenobu/keepassxc-run/pull/23
